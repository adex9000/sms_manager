        ...
        <div class="col-lg-8">
            ...
            <form action="{{ URL::route('send_sms') }}" role="form" method="post">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="destination_nos" name="destination_nos" rows="3" placeholder="Destination GSM Nos.">{{ Utilities::cleanGsmNos($gsm_numbers, true) }}</textarea>
