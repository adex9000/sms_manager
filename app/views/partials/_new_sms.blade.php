        ...
        <div class="col-lg-8">
            ...
            <form action="{{ URL::route('send_sms') }}" role="form" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="sender_id" name="sender_id" value="{{ Input::old('sender_id') }}" placeholder="Sender Label">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="destination_nos" name="destination_nos" rows="3" placeholder="Destination GSM Nos.">{{ Input::old('destination_nos') }}</textarea>
