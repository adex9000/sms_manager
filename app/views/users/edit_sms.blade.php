                        ...
                        <div class="col-lg-8">
                            ...
                            <form action="{{ URL::route('send_sms') }}" role="form" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="sender_id" name="sender_id" value="{{ $sms->senderno }}" placeholder="Sender Label">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="destination_nos" name="destination_nos" rows="3" placeholder="Destination GSM Nos.">{{ $sms->destinationnos }}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="sms_message" name="sms_message" rows="10" placeholder="Message">{{ $sms->messagebody }}</textarea>
                                </div>
                                ...
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" {{ ($sms->long_sms == 1)? 'checked="checked"' : '' }}  name="long_sms"> Send as long SMS?
                                    </label>
